...
Usuários finais provavelmente querem as
[páginas de funcionalidades](../index.md#headline-features) ou os
[guias de configuração](../setup/llm-providers.md), não esta seção.
...
- **[Constants](api/constants/index.md)** — chaves de configuração, códigos de erro, tabelas de idiomas, motores i18n / tema.

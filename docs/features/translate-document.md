...
localization formats, and more — with formatting preserved.
...
- Body text (with alignment detection — left / center / right / justify)
...
A failed task shows a red status with an error code and a localized

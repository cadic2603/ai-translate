---
description: Traduza seu primeiro documento com AI Translate em 5 minutos — arraste e solte um PDF, escolha um idioma de destino e baixe a cópia traduzida.
---

# Sua primeira tradução

Uma execução rápida de ponta a ponta — menos de 5 minutos depois que
a configuração estiver feita.
...
3. Arraste qualquer arquivo `.docx` para a zona de soltar — ou clique
   em **Procurar** para escolher um.

4. O arquivo aparece na fila. Escolha um idioma de destino no topo:
...
6. Observe a barra de progresso na tabela de histórico na parte
   ...
   linha para abrir o arquivo traduzido — salvo ao lado do original
...
- Uma entrada de histórico foi escrita em um banco SQLite para que
  você possa reabrir, reexecutar ou retraduzir o arquivo depois.
...
=== "Traduzir texto plano"
    ...
    escolha um destino, aperte Enter. Saída em streaming, troca de

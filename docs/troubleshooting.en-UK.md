...
### "Piper voice not installed" dialogue
...
1. Click **Open Settings** in the dialogue (or open **Settings →
   Voice** manually).
2. Make sure **TTS method** is set to **Piper TTS**.
3. Click **Download voices now** to open the voice library dialogue.
...
5. Close the dialogue and re-run your translation / voice / dub job.
...
dialogue — interrupting a live stream with a modal would be worse than

...
vivo, capturas de tela e mais, tudo através de um único pipeline movido
por LLM.

<div class="grid cards" markdown>

-   :material-cursor-default-click-outline:{ .lg .middle } **Aplicativo desktop**

    ---

    Arraste um arquivo, escolha um idioma de destino, receba uma cópia
...
-   :material-robot-outline:{ .lg .middle } **Agentes de IA (MCP)**
    ...
    [:octicons-arrow-right-24: Configuração MCP](mcp.md)
...
- **[Traduzir documento](features/translate-document.md)** — solte arquivos, observe um spinner de progresso por tarefa, receba cópias traduzidas lado a lado. Alvos RTL recebem markup bidi apropriado; `Ctrl+P` / `Ctrl+G` pausam e continuam a fila.
...
!!! tip "Modo Vertex AI para Gemini"
    Usuários enterprise podem trocar chamadas Gemini da API Developer
    para **Vertex AI** em **Configurações → LLM** — aponte para seu
